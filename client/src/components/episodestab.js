...
export default function EpisodeTab() {
	...
	const filterManger = (A, B) => {
		var manage = datatrus.filter(
			(x) => (A && x.displayname !== '') || (B && x.displayname === '')
								...
								<TableRow>
									{/* <TableCell>{title}</TableCell> */}
									{
										<TableCell
											...
											onClick={() => tablesorter('episodename', 'string')}
										>
											{' '}
											Display Name{' '}
											{arrowRetuner(
												sa === 'episodename' ? (order === 'asc' ? '1' : '2') : '3'
											)}{' '}
										</TableCell>
									}
									{
										<TableCell
											style={{ cursor: 'pointer', width: 30 }}
											onClick={() => tablesorter('language', 'string')}
										>
											{' '}
											Language{' '}
											{arrowRetuner(sa === 'language' ? (order === 'asc' ? '1' : '2') : '3')}{' '}
										</TableCell>
									}
									{
										<TableCell
											style={{ cursor: 'pointer' }}
											onClick={() => tablesorter('request', 'number')}
										>
											{' '}
											Request{' '}
											{arrowRetuner(sa === 'request' ? (order === 'asc' ? '1' : '2') : '3')}{' '}
										</TableCell>
									}
									{
										<TableCell
									...
									}
									{
										<TableCell
											style={{ cursor: 'pointer' }}
											onClick={() => tablesorter('publisher', 'string')}
										>
											{' '}
											Host{' '}
											{arrowRetuner(
												sa === 'publisher' ? (order === 'asc' ? '1' : '2') : '3'
											)}{' '}
										</TableCell>
									}
									{
									...
									}
									{
										<TableCell
											style={{ cursor: 'pointer' }}
											onClick={() => tablesorter('displayname', 'string')}
										>
											{' '}
											Episode Name{' '}
											{arrowRetuner(
												sa === 'displayname' ? (order === 'asc' ? '1' : '2') : '3'
											)}{' '}
										</TableCell>
									}
									{
										...
										>
											...
											Publisher Name{' '}
											{arrowRetuner(
												sa === 'publishername' ? (order === 'asc' ? '1' : '2') : '3'
											)}{' '}
										</TableCell>
									}
									{
										<TableCell
											style={{ cursor: 'pointer' }}
											onClick={() => tablesorter('hostPossibility', 'string')}
										>
											{' '}
											Host Possibility{' '}
											{arrowRetuner(
												sa === 'hostPossibility' ? (order === 'asc' ? '1' : '2') : '3'
											)}{' '}
										</TableCell>
									}
								...
								{(searchedData.length !== 0 ? searchedData : rows)
									...
									.map((row) => (
										<TableRow key={row.name}>
											...
											<TableCell>
												{row.language ? langmap.get(row.language) ? (
													langmap.get(row.language)
												) : (
													''
												) : (
													''
											...
											<TableCell>
												{row.category === '#N/A' ? row.new_taxonamy : row.category}
											</TableCell>
