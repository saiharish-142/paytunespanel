					...
					<Table className={classes.table} aria-label="simple table">
						...
						<TableBody>
							...
							>
								...
								<TableCell>
									{Math.round(target / timefinder(singlead.endDate, singlead.startDate) * 10) / 10}
								</TableCell>
								<TableCell>
									{Math.round(report.impressions / timefinder(Date.now(), singlead.startDate) * 10) /
										10}
								</TableCell>
