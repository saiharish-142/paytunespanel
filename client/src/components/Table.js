...
export default function BasicTable({singlead}) {
                    ...
                    <Table className={classes.table} aria-label="simple table">
                        ...
                        <TableBody>
                            <TableRow style={{
                                ...
                                <TableCell>{Math.round(report.impressions/timefinder(Date.now(),singlead.startDate[0])*10)/10}</TableCell>
    ...
    return (
        ...
        {audiologs.length ? <PublisherAdmin singlead={singlead} tablesorter={tablesorter} arrowRetuner={arrowRetuner} colorfinder={colorfinder} timefinder={timefinder} ids={ids} spentfinder={spentfinder} spentOffline={spentOffline} spentOfflined={spentOfflined} spentOfflinev={spentOfflinev} title='Audio' state1={state1} report={audiologs && audiologs} /> : ''}
        {displaylogs.length ? <PublisherAdmin singlead={singlead} tablesorter={tablesorter} arrowRetuner={arrowRetuner} colorfinder={colorfinder} timefinder={timefinder} ids={ids} spentfinder={spentfinder} spentOffline={spentOffline} spentOfflined={spentOfflined} spentOfflinev={spentOfflinev} title='Display' state1={state1} report={displaylogs && displaylogs} /> : ''}
        {videologs.length ? <PublisherAdmin singlead={singlead} tablesorter={tablesorter} arrowRetuner={arrowRetuner} colorfinder={colorfinder} timefinder={timefinder} ids={ids} spentfinder={spentfinder} spentOffline={spentOffline} spentOfflined={spentOfflined} spentOfflinev={spentOfflinev} title='Video' state1={state1} report={videologs && videologs} />: ''}
