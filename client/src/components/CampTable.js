					...
					<Table stickyHeader aria-label="sticky table">
						<TableHead>
							<TableRow>
								...
								<TableCell
									align="center"
									onClick={() => tablesorter('start', 1, 'date', 'startDate', true)}
									onDoubleClick={() => tablesorter('revstart', -1, 'date', 'startDate', true)}
									style={{ textAlign: 'center', alignItems: 'center', cursor: 'pointer' }}
								>
								...
								<TableCell
									align="center"
									onClick={() => tablesorter('end', 1, 'date', 'endDate', true)}
									onDoubleClick={() => tablesorter('revend', -1, 'date', 'endDate', true)}
									style={{ textAlign: 'center', alignItems: 'center', cursor: 'pointer' }}
								>
