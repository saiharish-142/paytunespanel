								...
								<TableRow>
									{/* <TableCell>{title}</TableCell> */}
									{
										<TableCell
											...
											onClick={() => tablesorter('_id.category', 'string')}
										>
											Category{' '}
											{arrowRetuner(sa === '_id.category' ? (order === 'asc' ? '1' : '2') : '3')}
										</TableCell>
									}
									{
										<TableCell
									...
									<TableCell
										style={{ cursor: 'pointer' }}
										onClick={() => tablesorter('extra_details.tier1', 'string')}
									>
										Tier1{' '}
										{arrowRetuner(
											sa === 'extra_details.tier1' ? (order === 'asc' ? '1' : '2') : '3'
										)}
									</TableCell>
									<TableCell
										style={{ cursor: 'pointer' }}
										onClick={() => tablesorter('extra_details.tier2', 'string')}
									>
										Tier2{' '}
										{arrowRetuner(
											sa === 'extra_details.tier2' ? (order === 'asc' ? '1' : '2') : '3'
										)}
									</TableCell>
									<TableCell
										style={{ cursor: 'pointer' }}
										onClick={() => tablesorter('extra_details.tier3', 'string')}
									>
										Tier3{' '}
										{arrowRetuner(
											sa === 'extra_details.tier3' ? (order === 'asc' ? '1' : '2') : '3'
										)}
									</TableCell>
									{
										<TableCell
											style={{ cursor: 'pointer' }}
											onClick={() => tablesorter('extra_details.tier4', 'string')}
										>
											Tier4{' '}
											{arrowRetuner(
												sa === 'extra_details.tier4' ? (order === 'asc' ? '1' : '2') : '3'
											)}
										</TableCell>
									}
									{
										<TableCell
											style={{ cursor: 'pointer' }}
											onClick={() => tablesorter('extra_details.genderCategory', 'string')}
										>
											Gender Category{' '}
											{arrowRetuner(
												sa === 'extra_details.genderCategory'
													? order === 'asc' ? '1' : '2'
													: '3'
											)}
										</TableCell>
									}
									{
										<TableCell
											style={{ cursor: 'pointer' }}
											onClick={() => tablesorter('extra_details.AgeCategory', 'string')}
										>
											Age category{' '}
											{arrowRetuner(
												sa === 'extra_details.AgeCategory' ? (order === 'asc' ? '1' : '2') : '3'
											)}
										</TableCell>
									}
									{
										<TableCell
											style={{ cursor: 'pointer' }}
											onClick={() => tablesorter('extra_details.new_taxonamy', 'string')}
										>
											New Taxonamy{' '}
											{arrowRetuner(
												sa === 'extra_details.new_taxonamy'
													? order === 'asc' ? '1' : '2'
													: '3'
											)}
										</TableCell>
								...
								{(searchedData.length !== 0 ? searchedData : rows)
									...
									.map((row) => (
										<TableRow key={row.name}>
											...
											<TableCell>
												{row.extra_details.tier1 ? row.extra_details.tier1 : ''}
											</TableCell>
											<TableCell>
												{row.extra_details.tier2 ? row.extra_details.tier2 : ''}
											</TableCell>
											<TableCell>
												{row.extra_details.tier3 ? row.extra_details.tier3 : ''}
											</TableCell>
											<TableCell>
												{row.extra_details.tier4 ? row.extra_details.tier4 : ''}
											</TableCell>
											<TableCell>
												{row.extra_details.genderCategory ? (
													row.extra_details.genderCategory
												) : (
													''
												)}
											...
											<TableCell>
												{row.extra_details.AgeCategory ? row.extra_details.AgeCategory : ''}
											</TableCell>
											<TableCell>
												{row.extra_details.new_taxonamy ? row.extra_details.new_taxonamy : ''}
											</TableCell>
											{/* <TableCell>
